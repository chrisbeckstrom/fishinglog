...
// get the number of FLY TRIPS this year
	...
	SELECT COUNT(*) FROM trips WHERE USERNAME = '$username' AND date >= '2013-01-01' AND GEAR = 'fly';
		");
	// put into an array	
...
// get the number of spin trips this year
	...
	SELECT COUNT(*) FROM trips WHERE USERNAME = '$username' AND date >= '2013-01-01' AND GEAR = 'spin';
		");
	// put into an array	
...
// get the number of fly/spin trips this year
	...
	SELECT COUNT(*) FROM trips WHERE USERNAME = '$username' AND date >= '2013-01-01' AND GEAR = 'fly and spin' OR GEAR = 'both';
		");
	// put into an array	
