...
print "</div>";
#print "<meta http-equiv='REFRESH' content='2;url=stats.php'>";			//html redirect, seemed easier than php
print "<a href='stats.php'>click here to see your stats</a>";
	}
...
// check if the TRIPNUMBER is set
	if(isset($_GET['tripnumber']))
		{
		print "<br><b>Adding another spot to tripnumber $tripnumber <br>";	// if it is, tell us
...
////////////////////////// FORM ///////////////////////////////////////
	...
	// TRIPNUMBER
	if(isset($_GET['tripnumber']))			// if the tripnumber is part of the URL
		{
		$existingtripnumber = $_GET['tripnumber'];	// grab it and make it $tripnumber
		print "the tripnumber is set! it is $existingtripnumber";
		$form->addTextbox("Tripnumber", "tripnumber", "$existingtripnumber");
		}
		else								// if the tripnumber is NOT part of the URL
		{
		...
		$newtripnumber = $highesttripnumber + 1;
			...
			//print "this new tripnumber will be $newtripnumber";
		$form->addTextbox("Tripnumber", "tripnumber", "$newtripnumber");
		}
