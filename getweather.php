...
$cities=array(
"Itasca"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/IL/Itasca.json",
"Batavia"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/IL/Batavia.json",
"Kalamazoo"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/MI/Kalamazoo.json",
"RockfordMI"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/MI/Rockford.json",
"Kentwood"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/MI/Kentwood.json",
"Flint"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/MI/Flint.json",
"Charleston"=>"http://api.wunderground.com/api/$apikey/geolookup/conditions/q/SC/Charleston.json"
	);
...
print "<BR> City : $city, $state <br>
			zip : $zip <br>
			lat/long : $lat, $lon<BR>
			Timezone is: $timezone <BR><BR>
