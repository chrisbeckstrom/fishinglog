...
<ul class="nav nav-tabs">
	<li class="active"><a href="#php5-1" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5)</a></li>
	<li><a href="#php53-1" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5 >= 5.3.0)</a></li>
</ul>

<div class="tab-content">
	<div id="php5-1" class="tab-pane active">
...
<ul class="nav nav-tabs">
	<li class="active"><a href="#php5-2" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5)</a></li>
	<li><a href="#php53-2" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5 >= 5.3.0)</a></li>
</ul>

<div class="tab-content">
	<div id="php5-2" class="tab-pane active">
...
<ul class="nav nav-tabs">
	<li class="active"><a href="#php5-3" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5)</a></li>
	<li><a href="#php53-3" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5 >= 5.3.0)</a></li>
</ul>

<div class="tab-content">
	<div id="php5-3" class="tab-pane active">
...
<ul class="nav nav-tabs">
	<li class="active"><a href="#php5-4" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5)</a></li>
	<li><a href="#php53-4" data-toggle="tab">PFBC <?php echo $version; ?> (PHP 5 >= 5.3.0)</a></li>
</ul>

<div class="tab-content">
	<div id="php5-4" class="tab-pane active">
