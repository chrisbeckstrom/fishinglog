...
this will be like the PLACE page for a body of water
  ...
  <head>
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        map.setCenter(
        new GLatLng(<?php echo "41.977, -88.016" ?>), 13);
...
if ( $stream == true )		// if it's a stream, load spots!
	{
	print "This is moving water.. loading stream spots..";
	}
	else					// if not, load a single lat/lon combination
	{
	print "<a href='https://maps.google.com/maps?q=$lat,+$lon'>$lat, $lon</a><br>"; // clickable link to gmaps
	}
