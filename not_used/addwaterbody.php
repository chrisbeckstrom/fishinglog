...
////////////////////////// FORM ///////////////////////////////////////
	...
	$form->addLatLng("", "lat_plus_long", array(41.983, -88.013), array( "style" => "width: 100%", "height" => 500, "width" => 700, "zoom" => 10));
	
	// NAME
	//$form->addTextbox("Waterbody name", "name");
	
print "Name: <input id='name' name='name' type='text' /> <br>";
	...
	$form->addCheckbox("", " private", "", array("private"));
...
///////////////////////// SUBMIT THE FORM ///////////////////////////////
	$form->addButton("Add the waterbody!");
	$form->render();

////////// TAKE LAT/LON FIND OUT CITY/COUNTY/STATE //////////////
	// get $lat and $lon
	include 'php/getlocationinfo.php';
