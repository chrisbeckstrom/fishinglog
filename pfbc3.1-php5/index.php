...
form that we'll talk through in detail.</p>
...
<p><strong>Line 1:</strong> PFBC uses PHP sessions in the validation process, so you'll need to ensure you have session_start(); in your 
...
<p><strong>Line 4:</strong> In order to create an instance of the Form class, you'll need to first include PFBC/Form.php.  Any other files (elements, views, etc)
will be autoloaded on-demand.</p>

<p><strong>Line 5:</strong> In the Form class' constructor, a unique identifier is supplied - <em>login</em> in this sample.  You'll reference
this same identifier in the validation process.</p>

<p><strong>Lines 6-20:</strong> Fields are added to the form with the addElement method.</p>

<p><strong>Line 21:</strong> The render method outputs the form's HTML, CSS, and javascript to the web browser.</p>
