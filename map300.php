<html>
    ...
    <div id='input'>
        ...
        mysql_connect($DBurl, $DBuser, $DBpass) or
        ...
        //print "<br>query is $mapquery<br>";
        $result = mysql_query($mapquery);
        
		$num_rows = mysql_num_rows($result);
 			//print "results: $num_rows rows <br>";
        ...
        while ($row = mysql_fetch_array($result, MYSQL_NUM))
        {
        	...
        	//print "tripid = $tripid, tripnumber = $tripnumber, user = $tripuser, lat = $lat lon = $lon <br>";
